    ...
    state.timer = setTimeout(async () => {
      try {
        ...
        await supabase.rpc("upsert_comparison_log", {
          ...
          p_cheaper_service: data.cheaperService ?? undefined,
          p_has_interacted: data.hasInteracted,
          p_donation_clicked: data.donationClicked,
          p_donation_amount: data.donationAmount ?? undefined,
          p_donation_confirmed: data.donationConfirmed,
          p_referrer: access.referrer ?? undefined,
          p_referrer_domain: access.referrer_domain ?? undefined,
          p_utm_source: access.utm_source ?? undefined,
          p_utm_medium: access.utm_medium ?? undefined,
          p_utm_campaign: access.utm_campaign ?? undefined,
          p_landing_path: access.landing_path ?? undefined,
          p_device_type: access.device_type ?? undefined,
          p_browser: access.browser ?? undefined,
          p_screen_width: access.screen_width ?? undefined,
          p_language: access.language ?? undefined,
          p_timezone: access.timezone ?? undefined,
